...
function setendpic()
{
	...
	$('#'+temp).css("background-image","url(PicGame/img/"+level+"/0"+(picnum-2)*(picnum-2)+".jpg)")
}
	...
	for(var i=1;i<picnum-1;i++)
	  {
			...
			if(id>picnum*i+1&&id<picnum*(i+1))
		{
			...
			$('#'+id).css("background-image","url(PicGame/img/"+level+"/0"+pic+".jpg)");
			pic++;
			//console.log(pic);
		}
		}
	...
	for(var i=1;i<picnum-1;i++)
	  {
		for(var id=1;id<picnum*picnum;id++)
		{
			if(id>picnum*i+1&&id<picnum*(i+1))
		{
			var temp=$('#'+id).css("background-image","url(PicGame/img/"+level+"/0"+a_num[k]+".jpg)");
			k++;
		}
		}
	  }
...
{
	$('.pic').css("background-image","url(PicGame/img/"+level+"/main.jpg)");
}
function windo()
{
